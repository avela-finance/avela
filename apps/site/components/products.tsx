...
const products = [
	{
		...
		name: "Spend",
		status: "Live",
		headline: "Checkout from your stock portfolio.",
		copy: "Pay at any checkout from spending power backed by tokenized stocks. The reserve settles in stablecoin while your xStocks stay locked in the vault — no selling, no liquidation, no surprises.",
	...
	},
	{
		...
		copy: "Send stablecoin backed by your tokenized stocks to a name, not an address. Claim a username, share your link, and get paid in seconds — settled onchain, receipted automatically.",
	...
	},
	{
		...
		name: "Borrow",
		status: "Live",
		headline: "Unlock cash against your stocks.",
		copy: "Your tokenized stocks set the limit. Pricing comes from the Uniswap V3 TWAP with a conservative haircut, so borrowing power moves with the market — and your positions never move at all.",
	...
	},
	{
		...
		name: "Agents",
		status: "Live",
		headline: "Give your agent a stock-backed allowance.",
		copy: "AI agents spend from your tokenized-stock portfolio within scoped permissions you define — per-transaction limits, asset restrictions, daily caps, always revocable. Built for humans and the agents working for them.",
	...
	},
	{
		...
		name: "Avela Card",
		status: "Coming soon",
		headline: "One card for your stock portfolio.",
		copy: "Spend anywhere cards are accepted, drawn from spending power backed by tokenized stocks. Join the list and get notified the moment cards ship.",
