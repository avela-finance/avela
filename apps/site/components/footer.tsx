		...
		<footer className="px-4 py-10 border-t border-border">
			<div className="max-w-5xl mx-auto flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
				...
				<nav className="flex items-center gap-5 text-sm text-muted-foreground">
					<a href="https://app.avela.xyz" className="transition-colors hover:text-foreground">
						App
					</a>
					<a href="https://docs.avela.xyz" className="transition-colors hover:text-foreground">
						Docs
					</a>
					<a
						href="https://github.com/avela-xyz"
						target="_blank"
